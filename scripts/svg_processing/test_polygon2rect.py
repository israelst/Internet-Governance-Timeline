...
class TestPolygonToRect(unittest.TestCase):
    ...
    def test_points_out_of_order(self):
        x = 18.0
        y = 610.764
        width = 20.315
        height = 546.088
...
class TestProcessLine(unittest.TestCase):
    def test_another_attr_at_the_begining(self):
        ...
        rect = '<rect fill="#B5454D" x="18.0" y="610.764" width="20.315" height="546.088"/>'
    ...
    def test_another_attr_at_the_end(self):
        ...
        rect = '<rect x="18.0" y="610.764" width="20.315" height="546.088" fill="#B5454D"/>'
        self.assertEqual(process_line(line), rect)
